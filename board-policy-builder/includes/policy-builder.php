<?php
/**
 * Fixed Policy Builder Backend - Resolves Content Loading Issues
...
class PolicyBuilder {
    ...
    private function render_policy_builder($post_id = 0) {
        ...
        // ✅ FIXED: Enhanced policy data retrieval with multiple fallbacks
        ...
        <div class="wrap policy-builder-wrap">
            ...
            <div class="policy-builder-layout">
                ...
                <div class="policy-details-column">
                    ...
                    <!-- Policy Content - ENHANCED LOADING -->
                    <div class="policy-field-group">
                        <label for="policy-content">Policy Content</label>
                        <?php
                        // ✅ FIXED: Use the enhanced content retrieval
    ...
    /**
     * ✅ ENHANCED: Comprehensive policy data retrieval with multiple fallbacks
     */
    ...
    public function save_policy() {
        ...
        // ✅ ENHANCED: Save ACF fields with additional verification
    ...
    /**
     * ✅ ENHANCED: Save policy fields with better error handling
     */
