...
Description: Comprehensive Board of Education meeting management with agenda templates, resolution workflows, and PDF generation.
Version: 2.0.1
...
// Plugin activation hook - UPDATED: Removed policy references
...
function boe_plugin_activate() {
    ...
    // Set default editor modes - UPDATED: Only meeting-related post types
    if (!get_option('boe_editor_modes')) {
        update_option('boe_editor_modes', [
            'meeting' => 'classic',
            'resolution' => 'classic'
            // Removed 'policy' => 'classic' since policies are now in separate plugin
        ]);
    }
